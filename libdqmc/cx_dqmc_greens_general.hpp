#ifndef CX_DQMC_GREENS_GENERAL_HPP
#define CX_DQMC_GREENS_GENERAL_HPP
...
namespace cx_dqmc {
    ...
    class greens_general : public cx_dqmc::abstract_greens {
	...
	greens_general(dqmc::parameters * p_, 
	...
	void update_on_left(int start, int stop,
			    int idx, int target);
	void update_on_right(int start, int stop,
			     int idx, int target);
