...
PARAPACK_SET_VERSION("SU(2) Invariant Determinantal QMC Simulations @ Finite T");
PARAPACK_REGISTER_ALGORITHM(cx_dqmc_replica_ft, "Complex DQMC");
PARAPACK_REGISTER_PARALLEL_ALGORITHM(cx_dqmc_replica_ft, "Complex DQMC");
